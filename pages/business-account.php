<section class="account-page account-page--business">
        ...
        <div class="account-content">
            <section id="b-company"><h2>Регистрация компании</h2><div class="form-grid"><input placeholder="ФИО"><input placeholder="Почта"><input type="tel" inputmode="tel" placeholder="+7 (___) ___-__-__"><input placeholder="Город"><input placeholder="Название компании"><input placeholder="ИНН"></div><button class="button button--small">Добавить компанию</button></section>
