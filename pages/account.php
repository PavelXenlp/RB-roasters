<section class="account-page">
        ...
        <div class="account-content">
            ...
            <section id="profile"><h2>Мои данные</h2><div class="form-grid"><input placeholder="ФИО"><input type="tel" inputmode="tel" placeholder="+7 (___) ___-__-__"><input placeholder="Почта"></div></section>
